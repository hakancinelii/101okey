...
const Lobby: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-okey-table flex flex-col items-center justify-start p-4 sm:p-6 text-white font-sans overflow-x-hidden overflow-y-auto no-scrollbar relative">
            {/* Ambient Background */}
            ...
            <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-3 gap-8 z-10 animate-in fade-in zoom-in-95 duration-500">
                ...
                {/* Right Side: Chat */}
                <div className="glass-hud rounded-[40px] border border-white/10 flex flex-col overflow-hidden shadow-3xl h-[320px] lg:h-auto lg:min-h-[500px]">
